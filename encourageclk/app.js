...
var encourage = var encourage = ["you\'re doing great!","pas de deux it!","you\'re amazing~","you got dis","keep going","you\'re one\nin a melon!","we\'re rooting\nfor you!","believe in\nyourself","dance like\nno one\'s\nwatching"];
...
Bangle.on('touch', (n, e) => {
  ...
  if (e.x > offset && e.y < height) { //bar
    ...
    g.setFont("Dylex7x13",2).setFontAlign(0,0).drawString(encouragement, width/2, height/2);
